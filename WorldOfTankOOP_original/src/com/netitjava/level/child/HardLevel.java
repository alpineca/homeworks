...
public class HardLevel extends Level {
	...
	final int START_ROW_BARIKADE_ZONE 			= 1; 
	final int ENEMY_TANKS_COUNT 				= 6;
	final int END_ROW_BARIKADE_ZONE 			= (GAME_BOARD_SIZE - 1);
	...
	protected boolean isBarikadeProcessable() {
